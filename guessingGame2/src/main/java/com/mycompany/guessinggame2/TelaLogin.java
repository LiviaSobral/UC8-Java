...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        login.setFont(new java.awt.Font("Rockwell", 0, 36)); // NOI18N
        login.setText("Login");
    ...
    private void textFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_textFocusGained
        if(text.getText().equals("Digite Seu Nome...")){
            text.setText("");
        }
    ...
    private void buttonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEntrarActionPerformed
        if(!text.getText().trim().equals("")||!text.getText().equals("Digite Seu Nome...")){
        Player player = new Player(text.getText());
        this.dispose();
        new Tela(player).setVisible(true);         
        }
